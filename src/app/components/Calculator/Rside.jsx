...
export default function Rside({ bmiResult, healthyCategory, xAxis, healthyweight1, healthyweight2, inc }) {
  return (
    <div className={styles.stylesRside}>
      {bmiResult === 'NaN' ? (
        ...
        <div className={styles.Rt}>
          ...
          <br /><br /><hr /><br />
          <h1 style={{ fontWeight: 'bold' }}>For your height, a healthy weight would be between <span style={{ fontSize: '40px', color: '#657E79', fontWeight: 'bold', marginLeft: '10px', marginRight: '10px' }}>{healthyweight1} & {healthyweight2}</span>{inc ? ("pounds") : ("kilograms")}</h1>
        </div>)}
    </div>
  );
}